#------------------------------------------#
# Title: Assignment06do     del table[intRowNr]
                blnCDRemoved = True
                break
        if blnCDRemoved:
...
class IO:
    ...
    @staticmethod
    def get_id():
        return input('Enter ID: ').strip()

    @staticmethod
    def get_title():
        return input('What is the CD\'s title? ').strip()

    @staticmethod
    def get_artist():
        return input('What is the Artist\'s name? ').strip()
